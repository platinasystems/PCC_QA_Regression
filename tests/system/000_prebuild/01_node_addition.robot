...
#####################################################################################################################################
    ...
    ${status}                       PCC.Add multiple nodes and check online
                                    ...  host_ips=['${CLUSTERHEAD_1_HOST_IP_SECONDARY}', '${CLUSTERHEAD_2_HOST_IP_SECONDARY}', '${SERVER_1_HOST_IP_SECONDARY}','${SERVER_2_HOST_IP_SECONDARY}','${SERVER_3_HOST_IP_SECONDARY}']
                                    ...  Names=['${CLUSTERHEAD_1_NAME_SECONDARY}', '${CLUSTERHEAD_2_NAME_SECONDARY}', '${SERVER_1_NAME_SECONDARY}','${SERVER_2_NAME_SECONDARY}','${SERVER_3_NAME_SECONDARY}']
