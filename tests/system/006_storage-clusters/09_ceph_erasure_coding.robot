...
###################################################################################################################################
        ...
        ${status}                   PCC.Ceph Make Mons Restart
                               ...  name=ceph-pvt
                                    Should Be Equal     ${status}  OK

###################################################################################################################################
Fetching Ceph Cluster ID before backup
###################################################################################################################################   

         ${ceph_cluster_id_before_backup}    PCC.Ceph Get Cluster Id
                                             ...  name=${CEPH_CLUSTER_NAME}                          
                                             Log To Console    ${ceph_cluster_id_before_backup}
                                             Set Global Variable    ${ceph_cluster_id_before_backup}           
