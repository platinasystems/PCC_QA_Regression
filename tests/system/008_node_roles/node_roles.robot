...
###################################################################################################################################
Fetching Node Role ID before backup
###################################################################################################################################   

         ${node_role_id_before_backup}    PCC.Get Node Role Id    
                                         ...    Name=${NODE_ROLE_5}
                                         Log To Console    ${node_role_id_before_backup}
                                         Set Global Variable    ${node_role_id_before_backup}    
