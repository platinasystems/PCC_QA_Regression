...
class Prometheus(PccBase):
    ...
    def check_connection_status_metrics(self):
        ...
        #     for promethius_object in eval(str(self.pcc_prometheus_objects)):
        #         print(f"Topic:{promethius_object}")
        ...
        #             payload = f'clusterHealthLevel{{nodeName="{nodeId}"}}&start={START_TIME}&end={END_TIME}&step={STEP}'
        #             data=get_response_data(pcc.query_metric(conn, payload))
        #             print("##############--clusterHealthLevel--##################")
        #             print("clusterHealthLevel Data:"+str(data))
        #             print("#####################################")
        #             if data:
        #                 continue
        #             else:
        ...
        #         if promethius_object=='admin_status_desired':
        #             payload = f'admin_status_desired{{nodeName="{nodeId}"}}&start={START_TIME}&end={END_TIME}&step={STEP}'
        #             data=get_response_data(pcc.query_metric(conn, payload))
        #             print("##############--admin_status_desired--##################")
        #             print("admin_status_desired Data:"+str(data))
        #             print("#####################################")
        #             if data:
        #                 continue
        #             else:
        ...
        #         if promethius_object=='carrier_status':
        #             payload = f'carrier_status{{nodeName="{nodeId}"}}&start={START_TIME}&end={END_TIME}&step={STEP}'
        #             data=get_response_data(pcc.query_metric(conn, payload))
        #             print("##############--carrier_status--##################")
        #             print("carrier_status Data:"+str(data))
        #             print("#####################################")
        #             if data:
        #                 continue
        #             else:
        ...
        #         if promethius_object=='connectionStatus':
        #             payload = f'connectionStatus{{nodeName="{nodeId}"}}&start={START_TIME}&end={END_TIME}&step={STEP}'
        #             data=get_response_data(pcc.query_metric(conn, payload))
        #             print("##############--connectionStatus--##################")
        #             print("connectionStatus Data:"+str(data))
        #             print("#####################################")
        #             if data:
        #                 continue
        #             else:
        ...
        #         if promethius_object=='audit':
        #             payload = f'audit{{nodeName="{nodeId}"}}&start={START_TIME}&end={END_TIME}&step={STEP}'
        #             data=get_response_data(pcc.query_metric(conn, payload))
        #             print("##############--audit--##################")
        #             print("audit Data:"+str(data))
        #             print("#####################################")
        #             if data:
        #                 continue
        #             else:
