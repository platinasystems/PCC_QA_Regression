pipeline {
    ...
    stages {
        ...
        stage('Run Tests') {
            steps {
                sh "docker run -v ${WORKSPACE}:/motor ${MOTOR_TEST_RUNNER} robot -x /motor/output/robot.xml --outputdir /motor/output /motor/pipeline/containers/motor-test-base/motor-test-base.robot"
            }
        }
